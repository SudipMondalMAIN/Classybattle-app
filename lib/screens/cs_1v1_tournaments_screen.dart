...
/// Dedicated browse page for Clash Squad 1v1 tournaments (format=cs_1v1).
...
class Cs1v1TournamentsScreen extends ConsumerStatefulWidget {
  const Cs1v1TournamentsScreen({super.key});

  @override
  ConsumerState<Cs1v1TournamentsScreen> createState() => _Cs1v1TournamentsScreenState();
}

class _Cs1v1TournamentsScreenState extends ConsumerState<Cs1v1TournamentsScreen> {
  final _searchController = TextEditingController();
  String _query = '';

  static const String _format = 'cs_1v1';
                          ...
                          Expanded(
                            child: TextField(
                              ...
                              decoration: const InputDecoration(
                                hintText: 'Search Clash Squad 1v1 tournaments...',
                                hintStyle: TextStyle(
                                  color: AppColors.textMuted,
                                  fontSize: 14,
                                ),
                  ...
                  sliver: tournamentsAsync.when(
                    ...
                    error: (_, __) => SliverToBoxAdapter(
                      child: Padding(
                        ...
                        child: Center(
                          child: Text(
                            'Couldn\'t load Clash Squad 1v1 tournaments',
                            style: const TextStyle(
                              color: AppColors.textMuted,
                              fontSize: 13,
                            ),
                        ...
                        return SliverToBoxAdapter(
                          child: Padding(
                            ...
                            child: Center(
                              child: Text(
                                tournaments.isEmpty
                                    ? 'No Clash Squad 1v1 tournaments yet'
                                    : 'No matches found',
                                style: const TextStyle(
                                  color: AppColors.textMuted,
                                  fontSize: 13,
