...
/// Dedicated browse page for Lone Wolf Head tournaments (format=lw_head).
...
class LwHeadTournamentsScreen extends ConsumerStatefulWidget {
  const LwHeadTournamentsScreen({super.key});

  @override
  ConsumerState<LwHeadTournamentsScreen> createState() => _LwHeadTournamentsScreenState();
}

class _LwHeadTournamentsScreenState extends ConsumerState<LwHeadTournamentsScreen> {

  static const String _format = 'lw_head';
                ...
                SliverPadding(
                  ...
                  sliver: SliverToBoxAdapter(
                    child: FormatPageBanner(
                      assetPath: 'assets/banners/lw_head_banner.jpg',
                    ),
                  ),
                ),
                  ...
                  sliver: tournamentsAsync.when(
                    ...
                    error: (_, __) => SliverToBoxAdapter(
                      child: Padding(
                        ...
                        child: Center(
                          child: Text(
                            'Couldn\'t load Lone Wolf Head tournaments',
                      ...
                      if (filtered.isEmpty) {
                        return SliverToBoxAdapter(
                          child: Padding(
                            ...
                            child: Center(
                              child: Text(
                                'No Lone Wolf Head tournaments yet',
                                style: const TextStyle(
                                  color: AppColors.textMuted,
                                  fontSize: 13,
                                ),
