                    ...
                    SliverPadding(
                      ...
                      sliver: SliverToBoxAdapter(
                        child: Consumer(builder: (context, ref, _) {
                          final statsAsync =
                              ref.watch(myTournamentStatsProvider);
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                ref
                                    .read(selectedTournamentTabProvider
                                        .notifier)
                      ...
                      sliver: SliverToBoxAdapter(
                        child: Consumer(builder: (context, ref, _) {
                          ...
                          return ProfileTournamentTabs(
                            selected: tab,
                            onSelect: (t) => ref
                                .read(profileTournamentTabProvider.notifier)
                                .state = t,
                          );
                        }),
                      ),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Consumer(builder: (context, ref, _) {
                              ...
                              return AccountSectionCard(rows: [
                                AccountRow(
                                  icon: Icons.account_balance_wallet_outlined,
                                  label: 'Wallet',
                                  trailingText: wallet.valueOrNull != null
                                      ? formatRupees(
                                          wallet.valueOrNull!.availableBalance)
                                      : null,
                                  onTap: () => Navigator.of(context).push(
                                    MaterialPageRoute(
                                ...
                                AccountRow(
                                  ...
                                  onTap: () => _notImplemented('Refer & Earn'),
                                ),
                                AccountRow(
