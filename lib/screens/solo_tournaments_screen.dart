...
/// Dedicated browse page for Solo tournaments (format=solo).
...
class SoloTournamentsScreen extends ConsumerStatefulWidget {
  const SoloTournamentsScreen({super.key});

  @override
  ConsumerState<SoloTournamentsScreen> createState() => _SoloTournamentsScreenState();
}

class _SoloTournamentsScreenState extends ConsumerState<SoloTournamentsScreen> {

  static const String _format = 'solo';
                ...
                SliverPadding(
                  ...
                  sliver: SliverToBoxAdapter(
                    child: FormatPageBanner(
                      assetPath: 'assets/banners/solo_tournaments_banner.jpg',
                    ),
                  ),
                ),
                  ...
                  sliver: tournamentsAsync.when(
                    ...
                    error: (_, __) => SliverToBoxAdapter(
                      child: Padding(
                        ...
                        child: Center(
                          child: Text(
                            'Couldn\'t load Solo tournaments',
