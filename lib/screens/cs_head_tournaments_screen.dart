...
/// Dedicated browse page for Clash Squad Head tournaments (format=cs_head).
...
class CsHeadTournamentsScreen extends ConsumerStatefulWidget {
  const CsHeadTournamentsScreen({super.key});

  @override
  ConsumerState<CsHeadTournamentsScreen> createState() => _CsHeadTournamentsScreenState();
}

class _CsHeadTournamentsScreenState extends ConsumerState<CsHeadTournamentsScreen> {
  final _searchController = TextEditingController();
  String _query = '';

  static const String _format = 'cs_head';
                          ...
                          Expanded(
                            child: TextField(
                              ...
                              decoration: const InputDecoration(
                                hintText: 'Search Clash Squad Head tournaments...',
                                hintStyle: TextStyle(
                                  color: AppColors.textMuted,
                                  fontSize: 14,
                                ),
                  ...
                  sliver: tournamentsAsync.when(
                    ...
                    error: (_, __) => SliverToBoxAdapter(
                      child: Padding(
                        ...
                        child: Center(
                          child: Text(
                            'Couldn\'t load Clash Squad Head tournaments',
                            style: const TextStyle(
                              color: AppColors.textMuted,
                              fontSize: 13,
                            ),
                        ...
                        return SliverToBoxAdapter(
                          child: Padding(
                            ...
                            child: Center(
                              child: Text(
                                tournaments.isEmpty
                                    ? 'No Clash Squad Head tournaments yet'
                                    : 'No matches found',
                                style: const TextStyle(
                                  color: AppColors.textMuted,
                                  fontSize: 13,
