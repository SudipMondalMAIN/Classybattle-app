...
/// Dedicated browse page for Squad tournaments (format=squad).
...
class SquadTournamentsScreen extends ConsumerStatefulWidget {
  const SquadTournamentsScreen({super.key});

  @override
  ConsumerState<SquadTournamentsScreen> createState() => _SquadTournamentsScreenState();
}

class _SquadTournamentsScreenState extends ConsumerState<SquadTournamentsScreen> {

  static const String _format = 'squad';
                ...
                SliverPadding(
                  ...
                  sliver: SliverToBoxAdapter(
                    child: FormatPageBanner(
                      assetPath: 'assets/banners/squad_tournaments_banner.jpg',
                    ),
                  ),
                ),
                  ...
                  sliver: tournamentsAsync.when(
                    ...
                    error: (_, __) => SliverToBoxAdapter(
                      child: Padding(
                        ...
                        child: Center(
                          child: Text(
                            'Couldn\'t load Squad tournaments',
