...
/// Dedicated browse page for BR Survive tournaments (format=br_survive).
...
class BrSurviveTournamentsScreen extends ConsumerStatefulWidget {
  const BrSurviveTournamentsScreen({super.key});

  @override
  ConsumerState<BrSurviveTournamentsScreen> createState() => _BrSurviveTournamentsScreenState();
}

class _BrSurviveTournamentsScreenState extends ConsumerState<BrSurviveTournamentsScreen> {

  static const String _format = 'br_survive';
                ...
                SliverPadding(
                  ...
                  sliver: SliverToBoxAdapter(
                    child: FormatPageBanner(
                      assetPath: 'assets/banners/br_survive_banner.jpg',
                    ),
                  ),
                ),
                  ...
                  sliver: tournamentsAsync.when(
                    ...
                    error: (_, __) => SliverToBoxAdapter(
                      child: Padding(
                        ...
                        child: Center(
                          child: Text(
                            'Couldn\'t load BR Survive tournaments',
