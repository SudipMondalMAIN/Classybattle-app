...
/// Dedicated browse page for Clash Squad 4v4 tournaments (format=cs_4v4).
...
class Cs4v4TournamentsScreen extends ConsumerStatefulWidget {
  const Cs4v4TournamentsScreen({super.key});

  @override
  ConsumerState<Cs4v4TournamentsScreen> createState() => _Cs4v4TournamentsScreenState();
}

class _Cs4v4TournamentsScreenState extends ConsumerState<Cs4v4TournamentsScreen> {
  final _searchController = TextEditingController();
  String _query = '';

  static const String _format = 'cs_4v4';
                          ...
                          Expanded(
                            child: TextField(
                              ...
                              decoration: const InputDecoration(
                                hintText: 'Search Clash Squad 4v4 tournaments...',
                                hintStyle: TextStyle(
                                  color: AppColors.textMuted,
                                  fontSize: 14,
                                ),
                  ...
                  sliver: tournamentsAsync.when(
                    ...
                    error: (_, __) => SliverToBoxAdapter(
                      child: Padding(
                        ...
                        child: Center(
                          child: Text(
                            'Couldn\'t load Clash Squad 4v4 tournaments',
                            style: const TextStyle(
                              color: AppColors.textMuted,
                              fontSize: 13,
                            ),
                        ...
                        return SliverToBoxAdapter(
                          child: Padding(
                            ...
                            child: Center(
                              child: Text(
                                tournaments.isEmpty
                                    ? 'No Clash Squad 4v4 tournaments yet'
                                    : 'No matches found',
                                style: const TextStyle(
                                  color: AppColors.textMuted,
                                  fontSize: 13,
