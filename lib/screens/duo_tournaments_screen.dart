...
/// Dedicated browse page for Duo tournaments (format=duo).
...
class DuoTournamentsScreen extends ConsumerStatefulWidget {
  const DuoTournamentsScreen({super.key});

  @override
  ConsumerState<DuoTournamentsScreen> createState() => _DuoTournamentsScreenState();
}

class _DuoTournamentsScreenState extends ConsumerState<DuoTournamentsScreen> {

  static const String _format = 'duo';
                ...
                SliverPadding(
                  ...
                  sliver: SliverToBoxAdapter(
                    child: FormatPageBanner(
                      assetPath: 'assets/banners/duo_tournaments_banner.jpg',
                    ),
                  ),
                ),
